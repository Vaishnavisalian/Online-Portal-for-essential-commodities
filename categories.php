    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-lg-4 mb-4" data-aos="zoom-in" data-aos-duration="1200">
         <a href="product.php?sub=2" style="text-decoration: none; color: black;"><div class="short d-flex flex-wrap align-items-center">
            <div class="icon">
        ...
        <div class="col-md-6 col-sm-6 col-lg-4 mb-4" data-aos="zoom-in" data-aos-duration="1200">
         <a href="product.php?sub=1" style="text-decoration: none; color: black;">
      ...
      <div class="row">
        <div class="col-lg-6" data-aos="flip-up" data-aos-duration="1800">
          <div class="serviceContainer">
            ...
            <h6>Categories</h6>
            <h3> <span>Shop&Safe</span> Categories</h3>
            <p> Now shop at the comfort of your own house. Get items delivered at your doorstep.
              STAY IN! STAY SAFE!
            </p>
                ...
                <div class="card-header p-0" id="headingOne">
                  <h2 class="mb-0">
                    <button class="btn  btn-block text-left p-3" type="button" data-toggle="collapse"
                      ...
                      01. Fresh Healthy Food & Dairy Products<i class="fas fa-location-arrow ml-3"></i>
                    </button>
                  </h2>
                </div>
                ...
                <div class="card-header p-0" id="headingTwo">
                  <h2 class="mb-0">
                    <button class="btn  btn-block text-left collapsed p-3" type="button" data-toggle="collapse"
                      ...
                      02. Household Supplies <i class="fas fa-location-arrow ml-3"></i>
                    </button>
                  </h2>
                </div>
                ...
                <div class="card-header p-0" id="headingThree">
                  <h2 class="mb-0">
                    <button class="btn btn-block text-left collapsed p-3" type="button" data-toggle="collapse"
                      ...
                      03. Electronic Appliances<i class="fas fa-location-arrow ml-3"></i>
                    </button>
        ...
        <div class="col-lg-6 col-md-10 col-sm-8 mt-4 mt-lg-0" data-aos="zoom-out" data-aos-duration="1800">
          <div class="imageContainer">
            ...
            <div class="round"></div>
            <img class="img1" style="height: 200px; width: 200px;" src="images/vegi.png" alt="" srcset="">
            <img class="img2" src="images/med.png" alt="" srcset="">
            <img class="img3" style="height: 250px; width: 200px;" src="images/hs.png" alt="" srcset="">
            <img class="img4" src="images/elec.png" alt="" srcset="">
