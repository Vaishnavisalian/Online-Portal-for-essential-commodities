     ...
     if($_GET['sub']==1){?>
       ...
       <div class="col-12 filter d-flex justify-content-center align-items-center mb-4">
          <ul class="d-flex flex-wrap mx-auto">
            ...
            <li class="list" data-filter="Tea">Tea</li>
            <li class="list" data-filter="Healthyfood">Healthy Food</li>
            <li class="list" data-filter="Vegetables">Vegetables</li>
            <li class="list" data-filter="Masala">Masala</li>
            <li class="list" data-filter="Dryfruits">Dry Fruits</li>
          </ul>
        </div>
<?php
     }
